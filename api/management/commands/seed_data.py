        ...
        data = [
            {
                'country': {
                    ...
                    'description': 'France is a nation that has profoundly shaped Western civilization. From the grandeur of Versailles to the bohemian streets of Montmartre, its history unfolds like a living museum. French cuisine is UNESCO-listed Intangible Cultural Heritage.',
                ...
                'cities': [
                    {
                        ...
                        'hotels': [
                            {'name': 'Le Grand Hôtel Paris', 'stars': 5, 'price_per_night': 420, 'rating': 4.9, 'budget_level': 'eleve', 'description': 'Legendary luxury on Boulevard des Capucines', 'image': 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=600'},
                        ...
                        'restaurants': [
                            ...
                            {'name': 'Breizh Café', 'cuisine_type': 'Crêperie', 'avg_price': 22, 'rating': 4.6, 'budget_level': 'budget', 'description': 'Best buckwheat galettes in the Marais', 'image': 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=600'},
                        ],
                        'activities': [
                        ...
                        'monuments': [
                            ...
                            {'name': 'Palace of Versailles', 'monument_type': 'Palace', 'entry_price': 20, 'rating': 4.7, 'description': 'Royal château with magnificent Hall of Mirrors', 'image': 'https://images.unsplash.com/photo-1595535873420-a599195b3f4a?w=600'},
                        ],
                    },
                    {
                        ...
                        'hotels': [
                            {'name': 'Hôtel Negresco', 'stars': 5, 'price_per_night': 380, 'rating': 4.9, 'budget_level': 'eleve', 'description': 'Iconic pink dome palace on the Promenade des Anglais', 'image': 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=600'},
                            {'name': 'Villa Saint-Exupéry', 'stars': 3, 'price_per_night': 55, 'rating': 4.6, 'budget_level': 'budget', 'description': 'Best hostel on the Riviera with stunning views', 'image': 'https://images.unsplash.com/photo-1555854877-bab0e564b8d5?w=600'},
                        ],
                        'restaurants': [
                            {'name': 'La Petite Maison', 'cuisine_type': 'Niçoise', 'avg_price': 65, 'rating': 4.8, 'budget_level': 'eleve', 'description': 'Celebrity hotspot for authentic Niçoise cuisine', 'image': 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=600'},
                        ],
                        'activities': [
            ...
            },
            {
                'country': {
                    ...
                    'language': 'Japanese', 'currency': 'Yen (¥)', 'climate': 'Temperate',
                    'continent': 'Asia', 'population': 125, 'rating': 4.9,
                    'best_season': 'Spring (Cherry Blossom)', 'avg_daily': '$100-150',
                    'visa_type': 'Visa on Arrival',
                    'description': 'Japan is a country where ancient traditions and futuristic technology coexist in perfect harmony. From serene temples to neon-lit cityscapes, every corner tells a story.',
                ...
                'cities': [
                    {
                        ...
                        'activities': [
                            {'name': 'Shibuya Crossing Experience', 'category': 'culture', 'price': 0, 'duration': '1 hour', 'rating': 4.8, 'description': 'World\'s busiest pedestrian crossing — pure urban energy', 'image': 'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=600'},
            ...
            },
            {
                'country': {
                    ...
                    'description': 'Morocco is a land of contrasts where the Sahara desert meets Atlantic coasts, and ancient medinas buzz with artisans. Spice-laden souks, riads and starry desert skies await.',
            ...
            },
            {
                'country': {
                    ...
                    'visa_type': 'Schengen Visa',
                    'description': 'Italy is an open-air museum where ancient ruins, Renaissance masterpieces and culinary excellence combine to create an unrivalled travel experience.',
            ...
            },
            {
                'country': {
                    ...
                    'visa_type': 'Visa on Arrival',
                    'description': 'Indonesia is an archipelago of 17,000 islands offering volcanic landscapes, ancient temples, world-class surf breaks and extraordinary cultural diversity.',
            ...
            },
            {
                'country': {
                    ...
                    'visa_type': 'Schengen Visa',
                    'description': 'Greece is the cradle of Western civilization, offering ancient ruins, whitewashed islands, turquoise waters and legendary hospitality.',
            ...
            },
            {
                'country': {
                    ...
                    'visa_type': 'Required',
                    'description': 'Algeria is Africa\'s largest country, offering Roman ruins, Saharan dunes, turquoise Mediterranean coasts and a rich Berber and Islamic heritage waiting to be discovered.',
            ...
            },
            {
                'country': {
                    ...
                    'visa_type': 'Schengen Visa',
                    'description': 'Spain captivates with flamenco rhythms, Gaudí architecture, sun-drenched beaches and tapas culture that turns every meal into a celebration.',
                ...
                'cities': [
                    {
                        ...
                        'description': 'Gaudí\'s city — where Gothic meets Art Nouveau on the Mediterranean.',
                        'image': 'https://images.unsplash.com/photo-1539037116277-4db20889f2d4?w=800',
                        'hotels': [
                        ...
                        'restaurants': [
                            {'name': 'Tickets', 'cuisine_type': 'Avant-garde Tapas', 'avg_price': 80, 'rating': 4.9, 'budget_level': 'eleve', 'description': 'Albert Adrià\'s playful tapas bar near Paral·lel', 'image': 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=600'},
                        ...
                        'activities': [
                            {'name': 'Sagrada Família Guided Tour', 'category': 'culture', 'price': 26, 'duration': '1.5 hours', 'rating': 4.9, 'description': 'Gaudí\'s unfinished masterpiece — UNESCO World Heritage', 'image': 'https://images.unsplash.com/photo-1539037116277-4db20889f2d4?w=600'},
                        ...
                        'monuments': [
                            {'name': 'Sagrada Família', 'monument_type': 'Cathedral', 'entry_price': 26, 'rating': 4.9, 'description': 'Gaudí\'s magnum opus — under construction since 1882', 'image': 'https://images.unsplash.com/photo-1539037116277-4db20889f2d4?w=600'},
                            {'name': 'Park Güell', 'monument_type': 'Park', 'entry_price': 10, 'rating': 4.7, 'description': 'Mosaic wonderland with panoramic views over Barcelona', 'image': 'https://images.unsplash.com/photo-1539037116277-4db20889f2d4?w=600'},
                        ],
                    },
                ],
            },
            {
                'country': {
                    ...
                    'description': 'Turkey bridges two continents and millennia of civilizations — Byzantine churches, Ottoman mosques, Cappadocian fairy chimneys and turquoise Aegean coasts.',
                ...
                'cities': [
                    {
                        ...
                        'hotels': [
                            ...
                            {'name': 'Vault Karakoy', 'stars': 4, 'price_per_night': 150, 'rating': 4.7, 'budget_level': 'moyen', 'description': 'Design hotel in a converted bank vault in Karaköy', 'image': 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=600'},
                        ],
                        'restaurants': [
                            ...
                            {'name': 'Karaköy Güllüoğlu', 'cuisine_type': 'Turkish Bakery', 'avg_price': 8, 'rating': 4.7, 'budget_level': 'budget', 'description': 'Istanbul\'s finest baklava since 1949', 'image': 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=600'},
                        ],
                        'activities': [
